...
class KomentarController extends Controller
{
    ...
    public function index($id){
        $komentar = Komentar::join('tbl_customer','tbl_komentar.customer_id','=','tbl_customer.id')->select('tbl_komentar.id','tbl_komentar.konten','tbl_customer.username')->where('barang_id',$id)->first();
        if($komentar){
            $statusCode = 200;
            $data = array(
                'code' => '200',
