...
<html>
	<head>
		<title>Canika - Confirm Reset Password</title>
							...
							<tbody>
								...
								<tr>
									<td style="padding:0px;font-size:12px;line-height:17px;color:#808080;font-family:Arial,Helvetica,sans-serif">
										<p style="font-size: 14px">Kami menerima permintaan untuk melakukan reset password terhadap akun anda.</p>
									</td>
								<tr>
									<td style="padding-top: 5px;">
										<a style="color:#fff; text-decoration: none; background-color: #E53072; padding: 10px 35px; font-size: 14px; line-height: 1.33; border-radius: 6px" href="{{route($route,["email" => $email])}}" target="_blank">Reset Password</a>
									</td>
								</tr>
								</tr>
								<tr>
